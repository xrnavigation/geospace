...
const EPSILON = 1e-10;
const engine = new GeometryEngine((a, b) =>
...
describe("Ray Intersection Tests", () => {
  describe("Ray vs Line Segment", () => {
    ...
    it("should detect intersection when ray hits segment", () => {
      const seg1: LineSegment = new LineSegment2D(
        new Point2D(2, -1),
        new Point2D(2, 1)
      );
    ...
    it("should return null when ray misses segment", () => {
      const seg2: LineSegment = new LineSegment2D(
        new Point2D(0, 1),
        new Point2D(1, 1)
      );
...
describe("Raycast Edge Cases", () => {
  it("returns null for ray with zero direction vector on segment", () => {
    ...
    const seg: LineSegment = new LineSegment2D(
      new Point2D(1, 1),
      new Point2D(2, 2)
    );
